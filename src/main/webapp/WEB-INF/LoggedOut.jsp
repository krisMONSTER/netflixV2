...
<div id="banner_div">
    <div id="logo_div"><a href="${pageContext.request.contextPath}/Welcome"><img id="logo_img" src="${pageContext.request.contextPath}/images/logoV2.png" alt="Logo firmy"></a></div>
    <div id="user_div"><img id="account_img" src="${pageContext.request.contextPath}/images/user_szary.png" alt="Konto"></div>
</div>
<div id="panel">
    <div class="wrap">
        <div class="panel_element" onmouseover="mouseOverPanelElement(this)" onmouseout="mouseOutPanelElement(this)" id="search_div">
            <span id="search"></span>
        </div>
        <div class="panel_element" onmouseover="mouseOverPanelElement(this)" onmouseout="mouseOutPanelElement(this)" id="test_div">
...
<div id="menu_div">
    <p onclick="window.location.href = '${pageContext.request.contextPath}/LoginNav'" class="menu_element" id="log_in"></p>
